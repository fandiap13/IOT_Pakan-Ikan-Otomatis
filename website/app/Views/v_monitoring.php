...
<div class="col-lg-4 text-sm">
  <div class="card card-primary card-outline">
    ...
    <div class="card-body">
      <ul class="list-group">
        <li class="list-group-item bg-primary"><i class="fas fa-fish"></i> Pemberian Pakan</li>
      ...
      <ul class="list-group mt-3">
        <li class="list-group-item bg-primary"><i class="fas fa-fish"></i> Ikan</li>
        <li class="list-group-item">
          <b>Jenis Ikan : </b><br>
      ...
      <div class="info-box mt-3">
        <span class="info-box-icon bg-white elevation-1 akuarium-info"><i class="fab fa-hotjar"></i></span>
        <div class="info-box-content">
          <span class="info-box-text">Penghangat Akuarium</span>
          <span class="info-box-number penghangat_akuarium_control">
          </span>
        </div>
      </div>

      <div class="info-box mt-3">
        <span class="info-box-icon bg-warning elevation-1 alarm-info"><i class="fas fa-bell-slash"></i></span>
        <div class="info-box-content">
          <span class="info-box-text">Alarm Pakan Habis</span>
          <span class="info-box-number alarm_pakan">
          </span>
        </div>
      </div>
    ...
    $.ajax({
      ...
      success: function(response) {
        if (response.data) {
          ...
          if (data.penghangat_akuarium == "ON") {
            $(".akuarium-info i").addClass("text-danger");
          } else {
            $(".akuarium-info i").removeClass("text-danger");
          }

          if (data.buzzer == "ON") {
            $(".alarm-info").html(`<i class="fas fa-bell"></i>`);
          } else {
            $(".alarm-info").html(`<i class="fas fa-bell-slash"></i>`);
          }
